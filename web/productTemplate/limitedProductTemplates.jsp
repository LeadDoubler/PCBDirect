...
<c:forEach items="${actionBean.productTemplates}" var="productTemplate">
    <c:if test="${productTemplate.published || actionBean.context.user.role.value == 5}">
        <c:if test="${(empty actionBean.pt1 && empty actionBean.pt2 && empty actionBean.pt3) || actionBean.pt1 eq productTemplate.id || actionBean.pt2 eq productTemplate.id || actionBean.pt3 eq productTemplate.id}">
            <div class="productTemplate">
                ...
                <div>
                    ...
                    <h4><a target="_blank" href="${pageContext.request.contextPath}/productTemplate/ProductTemplate.action?orderProduct&productTemplate=${productTemplate}">Buy now</a></h4>
                </div>
