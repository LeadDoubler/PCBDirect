        ...
        <div class="container">
            <div class="suckerfish" id="horiz-menu" style="margin:0 10px -34px 34%;width:64%;">
                <ul class="menutop">
                    ...
                    <li id="permission"><a href="http://www.azitech.dk/Stencils-Standard/stencils.html"><span>Advance Permission</span></a></li>
                                                ...
                                                <div style="margin: 0 0 0 20px;">
                                                    ...
                                                    <table width="50%" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td>Allow editors to invite others to edit or view</td>
                                                        </tr>
                                                        <tr>
                                                            <td/>
                                                            <td>Editors can see who else </td>
                                                        </tr>
                                                        <tr>
                                                            <td/>
                                                            <td>
                                                                <table border="0" cellpadding="0">
                                                                    <tr>
                                                                        <td><stripes:submit name="saveclose" value="Save & Close" class="login"/></td>
                                                                        <td><stripes:submit name="cancel" value="Cancel" class="login"/></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        <tr><td height="8"></td></tr>
                                                        <tr><td colspan="2"><a class="bulink" href="${pageContext.request.contextPath}/share/Sharing.action">Back to Sharing Dashboard</a></td></tr>
                                                        <tr><td height="8"></td></tr>
                                                    </table>
                                                    </stripes:form>
                                                </div>
