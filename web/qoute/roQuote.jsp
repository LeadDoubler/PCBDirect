                            ...
                            <tr>
                                <td colspan="2" align="left" valign="top">
                                    <div id="ddtabs4" class="ddcolortabs">
                                        <ul>
                                            <li><a id="link_ct1" onclick="window.location = '${pageContext.request.contextPath}/qoute/Qoute.action?backToSpecificationRO&specification=${actionBean.specification.id}';"><span>PCB specification</span></a></li>
                                            <li><a id="link_ct2" onclick="window.location = '${pageContext.request.contextPath}/qoute/Qoute.action?backToSpecificationRO&specification=${actionBean.specification.id}&tab=layout';"><span>Layout</span></a></li>
                                    ...
                                    <div class="tabcontainer">
                                        <div id="ct4" class="tabcontent">
                                            <div style="margin: 5px 0 0 6px;">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <span class="form_right">
                                                                                ...
                                                                                </select><img class="info" src="../images/info.png" onmouseover="showToolTip(this, '<u>Economy</u>: Economy 5 working days.<br/><br/><u>Express</u>: Express 3 working day.<br/><br/><u>By Ship</u>: By ship 30 working days, large cargo.<br/><br/>* Delivery in Sweden, one aditional working day will be added.<br/>* Delivery in Norway, three aditional working day will be added.');" onmouseout="hideToolTip();"/>
                                                                            </span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr><td height="8"></td></tr>
                                                                        ...
                                                                        <td valign="top">
                                                                            <span class="form_right">
                                                                                <stripes:button  class="login" style="cursor:pointer" id="updateReorder" name="updateReorder" value="Calculate"
                                                                                                 onclick="$('right_qoute').innerHTML='<span class=\"title\">Please wait..</span>';$('qouten').value='';voke($('#form'), this.name, 'right_qoute');"/>
                                                                            </span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td class="rounded_leftrightborder">
                                                                ...
                                                                <div class="roundedtable" style="height:200px;overflow:scroll;overflow-x:hidden;width:819px;">
                                                                    <table width="803" border="0" cellpadding="0" cellspacing="0" class="round-table">
                                                                        <tbody>
                                                                            <c:forEach var="qoute" items="${actionBean.qoutesRO}" varStatus="loopid">
                                                                                <c:if test="${qoute.specification.id == actionBean.specification.id}">
                                                                                    <tr class="gray${loopid.index%2}">
                                                                                        ...
                                                                                        <td width="60" align="center"><fmt:formatNumber value="0" minFractionDigits="2" maxFractionDigits="2"/></td>
                                                                                        ...
                                                                                        <td width="75" align="right"><fmt:formatNumber value="${(100- qoute.user.discount) * 0.01 * (qoute.total - qoute.tooling)}" maxFractionDigits="2" minFractionDigits="2"/></td>
                                                                                        <c:choose>
                                                                                            <c:when test="${qoute.freez eq true}"><td width="40" align="center"><img style="cursor:default" src="${pageContext.request.contextPath}/images/del0.png" width="16" height="16"></td></c:when>
                                                                                            <c:otherwise><td width="40" align="center"><img style="cursor: pointer" title="Delete" src="${pageContext.request.contextPath}/images/del1.png" width="16" height="16"  onclick="if (confirm('Delete: Are you sure?'))
                                                                                                        window.location = '${pageContext.request.contextPath}/qoute/Qoute.action?delete&sp=r&qoute=${qoute.id}&specification=${qoute.specification.id}';"></td></c:otherwise>
                                                                                            </c:choose>
                                                ...
                                                <div style="margin: 5px 0 0 6px;">
                                                    <span><input type="button" class="login" style="cursor:pointer" value="Back" onclick="window.location = '${pageContext.request.contextPath}/qoute/Qoute.action?backToSpecificationRO&specification=${actionBean.specification.id}&tab=layout';"/></span>
                                                        <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <c:choose>
                                                                <c:when test="${!empty actionBean.qoutesRO}">
