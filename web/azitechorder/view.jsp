                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                        ...
                                                                                        </c:choose><a class="btn btn-default pull-right" onclick="javascript:window.location = '#link_ct6';<c:if test="${sessionScope.user.role.value < 4}">document.getElementById('pageHead').innerHTML='Order & delivery';</c:if>show('ct6');">Next</a>
                                                                    ...
                                                                    <div class="actionBar">
                                                                            <c:choose>
                                                                                <c:when test="${actionBean.order.status == 'Incomplete'}">
                                                                                    <c:choose>
                                                                                        <c:when test="${actionBean.order.date == null}">
                                                                                            <a class="btn btn-default pull-left" onclick="javascript:window.location = '#link_ct5';<c:if test="${sessionScope.user.role.value < 4}">document.getElementById('pageHead').innerHTML='Verify specifications';</c:if>show('ct5');">Back</a>
                                                                                            <c:choose>
