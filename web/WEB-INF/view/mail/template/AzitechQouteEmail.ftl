...
<h2>Quotation from PCB-direct</h2>
<br/>

<table border="0" cellpadding="0" cellspacing="0">
    <tr><td colspan="3">Dear <font style="color:red;"><b>${user.username}</b></font> you have requested the below quotation to be sent to you.</td></tr>
            ...
            <table style="text-align:left">
                ...
                <#if specification.layout == 'Panel'>
                    ...
                    <#if specification.azpanelization == 'Azitech'>
                        <tr>
                            <th align="left">PCB dimension (X)</th>
                            <td>:</td>
                            <td>${specification.azpcbdimx} mm (X-direction)</td>
                        </tr>

                        <tr>
                            <th align="left">PCB dimension (Y)</th>
                            <td>:</td>
                        ...
                        <tr>
                            <th align="left">Numbers of PCB's in the panel</th><td>:</td>
                            <td>${specification.aznrofpcb} pcs.</td>
                        </tr>
                    ...
                    <#if specification.azpanelization == 'Your own panel'>
                        ...
                        <tr>
                            <th align="left">PCB's per panel</th><td>:</td>
                            <td>${specification.azprintperpanel}</td>
                        </tr>
