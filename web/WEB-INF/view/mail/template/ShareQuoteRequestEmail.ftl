...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr><td><font style="color:red"><b>${fromuser.fullname!""}</b></font> from ${fromuser.company!""} has shared quotations with you on <a href="http://pcb-direct.dk">http://pcb-direct.dk</a></td></tr>
    <tr><td height="8"></td></tr>
