...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
   ...
   <%@ attribute name="def" required="false" %>
    ...
    <c:if test="${ sessionScope.user.role.value > 3 and page != null and type eq 'file'}">
        <span class="actions">
                    <a href="#" onclick="ajax('fckeditorWindow','${pageContext.request.contextPath}/part/Part.action?inline&part.page=${page}&part.name=${part}&part=${page.parts[part]}&type=${type}');return false"><img width="12" height="12" alt="Rediger"  src="${pageContext.request.contextPath}/images/green_edit.gif"/></a>
                </span>
