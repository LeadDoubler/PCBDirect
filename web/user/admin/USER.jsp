                                          ...
                                          <c:forEach var="spec" items="${specificationManager.userSpecs}" varStatus="loopid">
                                              <c:choose>
                                                  ...
                                                  <c:choose>
                                                      <c:when test="${spec.specAccess eq 9}">
                                                          <c:choose>
                                                              <c:when test="${spec.isorderplaced == 'Y'}"><td width="10%" align="center"><img src="${pageContext.request.contextPath}/images/del0.png" alt="locked"></td></c:when>
                                                              <c:otherwise><td width="10%" align="center" onmousedown="if(confirm('Are you sure you want to delete this specification?')) {window.location='${pageContext.request.contextPath}/specification/Specification.action?delete&specification=${spec.id}'; return false;}else return false;"><img src="${pageContext.request.contextPath}/images/del0.png" onmouseover="this.src='${pageContext.request.contextPath}/images/del1.png';" onmouseout="this.src='${pageContext.request.contextPath}/images/del0.png';" alt="delete"></td></c:otherwise>
                                                          </c:choose>
                                                      </c:when>
