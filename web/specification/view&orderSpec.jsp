                            ...
                            <td colspan="2" align="left" valign="top">
                                <div id="ddtabs4" class="ddcolortabs">
                                    <ul>
                                        ...
                                        <li><a id="link_ct4" onclick="window.location = '${pageContext.request.contextPath}/qoute/Qoute.action?initializeOrderWithViewOrderAccess=&specification=${actionBean.specification.id}'"><span>Calculate Price</span></a></li>
                                                ...
                                                <td>
                                                    <table border="0" cellpadding="0">
                                                        <tr>
                                                            ...
                                                            <td class="login"><a onclick="window.location = '${pageContext.request.contextPath}/qoute/Qoute.action?initializeOrderWithViewOrderAccess=&specification=${actionBean.specification.id}'">Next</a></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
