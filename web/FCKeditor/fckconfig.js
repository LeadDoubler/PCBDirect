...
//FCKConfig.BasePath + 'css/fck_editorarea2.css'
FCKConfig.EditorAreaCSS =  'styles/layout2.css';
...
FCKConfig.ToolbarSets["Page"] = [
	['Source','-','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','PasteWord'],
        ['Image','Flash','Table','Rule','SpecialChar'],
        ['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
        ['Indent','FontFormat']
] ;

FCKConfig.ToolbarSets["link"] = [
	['Bold','Link']
];

FCKConfig.ToolbarSets["File"] = [
	['Source','Image','Flash','Link']
];

FCKConfig.ToolbarSets["Part"] = [
	['Source','Bold','Italic','OrderedList','UnorderedList','PasteWord'],
        ['Link','Unlink','Flash','Image','Table','Rule'],
        ['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
        ['FontSize','SpecialChar']
] ;

FCKConfig.ToolbarSets["Catalog"] = [
	['Source','-','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','PasteWord'],
        ['Image','Flash','Table','Rule','SpecialChar'],
...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','PasteWord','-','About']
] ;
