...
<jsp:useBean id="bookManager" scope="page" class="com.asap.catalog.dao.manager.BookManager" />
...
<html>
	...
	<body scroll="no" style="OVERFLOW: hidden" >
		<div id="divInfo" style="DISPLAY: none">
			<span fckLang="DlgLnkType">Hvilken type link vil ud indsætte?</span><br />
			<select id="cmbLinkType" onchange="SetLinkType(this.value);">
				...
				<option value="email" fckLang="DlgLnkTypeEMail">E-Mail</option>
                                <option value="page" fckLang="DlgLnkTypePage" >Page</option>
			</select>
			<br />
			<br />
			...
			<div id="divLinkTypeEMail" style="DISPLAY: none">
				...
				<textarea id="txtEMailBody" style="WIDTH: 100%" rows="3" cols="20"></textarea>
                        ...
                        <div id="divLinkTypePage" style="DISPLAY: none">
                            <span>Vælg side herunder:</span><br/>
                            <select id="cmbPageType" onchange="${'txtUrl'}.value = '${pageContext.request.contextPath}/page/'+this.options[this.selectedIndex].title;OnUrlChange();">
                                <option selected="selected">(- side -)</option>
                                <c:forEach items="${page.tree}" var="p">
                                    <option value="${p.title}" title="${p.id}">${p.treeTitle}</option>
                                </c:forEach>
                            </select>
                        </div>
		</div>
