...
function SetLinkType( linkType )
{
	...
	ShowE('divLinkTypeEMail'	, (linkType == 'email') ) ;
        ShowE('divLinkTypePage'         , (linkType == 'page') ) ;
	...
	if ( !FCKConfig.LinkDlgHideAdvanced )
		window.parent.SetTabVisibility( 'Advanced'	, ((linkType != 'anchor' || bHasAnchors) ) && linkType != 'page') ;
		...
		switch ( GetE('cmbLinkType').value )
		{
			...
			case 'email':
				...
				break ;
                        ...
                        case 'page':
                                sInnerHtml = GetE('cmbPageType').value ;
				break ;
